...
class WarnaQuiz {
  ...
  var choices = [
    ...
    ["Hijau", "Hitam", "Kuning", "Merah"],
    ["Hijau", "Hitam", "Kuning", "Merah"],
    ["Oranye", "Perak", "Putih", "Ungu"],
    ["Oranye", "Perak", "Putih", "Ungu"],
    ["Oranye", "Perak", "Putih", "Ungu"],
    ["Oranye", "Perak", "Putih", "Ungu"],
    ["Warna", "Perak", "Putih", "Ungu"],
  ];
...
class KuisWarna extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new KuisWarnaState();
  }
}

class KuisWarnaState extends State<KuisWarna> {
  @override
          ...
          body: new Container(
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Image.asset(
                  "img/materi/10warna/${quiz.images[questionNumber]}.gif",
                ),
