...
class KataSifatQuiz {
  ...
  var choices = [
    ["Baik", "Emosi", "Malas", "Marah"],
    ["Baik", "Emosi", "Malas", "Marah"],
    ["Baik", "Emosi", "Malas", "Marah"],
    ["Baik", "Emosi", "Malas", "Marah"],
    ["Rajin", "Sabar", "Semangat", "Marah"],
    ["Rajin", "Sabar", "Semangat", "Marah"],
    ["Rajin", "Sabar", "Semangat", "Marah"],
...
class KuisKataSifat extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new KuisKataSifatState();
  }
}

class KuisKataSifatState extends State<KuisKataSifat> {
  @override
          ...
          body: new Container(
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Image.asset(
                  "img/materi/9katasifat/${quiz.images[questionNumber]}.gif",
                ),
