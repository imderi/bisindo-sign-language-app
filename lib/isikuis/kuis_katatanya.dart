...
class KataTanyaQuiz {
  ...
  var choices = [
    ["Apa", "Bagaimana", "Dimana", "Kapan"],
    ["Apa", "Bagaimana", "Dimana", "Kapan"],
    ["Apa", "Bagaimana", "Dimana", "Kapan"],
    ["Apa", "Bagaimana", "Dimana", "Kapan"],
    ["Mengapa", "Siapa", "Dimana", "Kapan"],
    ["Mengapa", "Siapa", "Dimana", "Kapan"],  
  ];
...
class KuisKataTanya extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new KuisKataTanyaState();
  }
}

class KuisKataTanyaState extends State<KuisKataTanya> {
  @override
          ...
          body: new Container(
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Image.asset(
                  "img/materi/5katatanya/${quiz.images[questionNumber]}.gif",
                ),
