...
class SapaanQuiz {
  ...
  var choices = [
    ["Assalamualaikum", "Halo", "Selamat Pagi", "Selamat Datang"],
    ["Assalamualaikum", "Halo", "Selamat Pagi", "Selamat Datang"],
    ["Assalamualaikum", "Halo", "Selamat Pagi", "Selamat Datang"],
    ["Assalamualaikum", "Halo", "Selamat Pagi", "Selamat Datang"],
    ["Terimakasih", "Sama-sama", "Maaf", "Halo"],
    ["Terimakasih", "Sama-sama", "Maaf", "Halo"],
    ["Terimakasih", "Sama-sama", "Maaf", "Halo"],
...
class KuisSapaan extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new KuisSapaanState();
  }
}

class KuisSapaanState extends State<KuisSapaan> {
  @override
          ...
          body: new Container(
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Image.asset(
                  "img/materi/3sapaan/${quiz.images[questionNumber]}.gif",
                ),
